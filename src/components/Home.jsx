...
>
  ...
  >
    ...
    <motion.div
      ...
      className="mb-6 w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 rounded-full overflow-hidden border-4 border-gray-700 shadow-lg"
    >
      <img 
    ...
    <p className="mb-6 max-w-xl text-base sm:text-lg text-gray-300">
